...
# STREAM_BASE_URL: public URL of this bot's web server (e.g. https://yourbot.koyeb.app)
# BIN_CHANNEL:     private channel ID where files are copied for streaming (integer)
...
PM_FILTER_ENABLED = is_enabled(environ.get('PM_FILTER_ENABLED', 'True'), True)
...
LOG_STR += ("PM filter is enabled for private/group searches.\n" if PM_FILTER_ENABLED else "PM filter is disabled.\n")
